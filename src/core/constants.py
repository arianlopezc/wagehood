...
LOCAL_CACHE_SIZE = 10000    # Maximum items in local cache (for fallback)
REDIS_HOST = "localhost"
REDIS_PORT = 6379
REDIS_DB = 0
REDIS_PASSWORD = None
USE_REDIS_CACHE = True      # Redis is primary datastore
USE_LOCAL_ONLY = False      # Set to True to force local-only mode
