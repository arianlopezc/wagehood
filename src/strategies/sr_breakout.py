...
class SupportResistanceBreakout(TradingStrategy):
    ...
    def __init__(self, parameters: Dict[str, Any] = None):
        ...
        default_params = {
            ...
            "min_confidence": 0.55,  # Lowered from 0.7
    ...
    def _check_resistance_breakout(
        ...
        signal = {
            ...
            "metadata": self.get_signal_metadata(
                signal_name="Resistance Level Breakout",
    ...
    def _check_support_breakout(
        ...
        signal = {
            ...
            "strategy_name": self.name,
            "metadata": self.get_signal_metadata(
                signal_name="Support Level Breakout",
    ...
    def _validate_signal_strategy(self, signal: Dict[str, Any]) -> bool:
        ...
        valid_signal_names = ["Resistance Level Breakout", "Support Level Breakout"]
