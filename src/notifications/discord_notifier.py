...
class DiscordNotifier:
            ...
            for attempt in range(self.max_retries):
                try:
                    ...
                    if success:
                        ...
                        logger.warning(
                            f"Discord request failed, attempt {attempt + 1}/{self.max_retries}"
                        )
        ...
        try:
            ...
            with urllib.request.urlopen(request, timeout=10) as response:
                ...
                if status_code == 200 or status_code == 204:
                    ...
                    logger.warning(
                        f"Discord webhook returned {status_code}: {response_data}"
                    )
                    return False
            ...
            if e.code == 429:  # Rate limited
                ...
                if retry_after:
                    logger.info(
                        f"Discord rate limit: retry after {retry_after} seconds"
                    )
    ...
    def send_test_message(self, is_test_environment: bool = False) -> bool:
        ...
        test_embed = {
            ...
            "footer": {"text": "Wagehood Trading System Test"},
