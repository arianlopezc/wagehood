...
class MessageFormatter:
    ...
    # Signal emojis
    SIGNAL_EMOJIS = {"BUY": "📈", "SELL": "📉", "HOLD": "⚖️", "UNKNOWN": "❓"}
    ...
    def format_signal_embed(self, signal_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            embed = {
                ...
                "footer": {"text": "Paper Trading • Not Financial Advice • Wagehood"},
    ...
    def _format_signal_details(
        self, details: Dict[str, Any], signal_data: Dict[str, Any]
    ) -> str:
        """
    ...
    def format_system_status_embed(self, status_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            embed = {
                ...
                "color": color,
                "fields": [{"name": "Status", "value": status.title(), "inline": True}],
                "footer": {"text": "Wagehood System Monitor"},
    ...
    def _create_error_embed(self, error_message: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "color": self.COLORS["SELL"],
            "footer": {"text": "Wagehood System Error"},
            "timestamp": datetime.utcnow().isoformat(),
        }
