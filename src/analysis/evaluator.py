...
class PerformanceEvaluator:
    ...
    def calculate_all_metrics(
        ...
        # Combine all metrics
        return PerformanceMetrics(**basic_metrics, **risk_metrics, **advanced_metrics)
    ...
    def _calculate_advanced_metrics(
        ...
        max_consecutive_wins, max_consecutive_losses = (
            self._calculate_consecutive_stats(trade_pnls)
        )
    ...
    def calculate_var(
        self, equity_curve: List[float], confidence_level: float = 0.05
    ) -> float:
    ...
    def calculate_omega_ratio(
        self, equity_curve: List[float], threshold: float = 0.0
    ) -> float:
    ...
    def calculate_trade_metrics(self, trades: List[Trade]) -> Dict[str, Any]:
        ...
        # Duration analysis
        durations = [
            t.duration_hours for t in closed_trades if t.duration_hours is not None
        ]
    ...
    def rank_strategies_by_metric(
        self, backtest_results: List[BacktestResult], metric: str = "sharpe_ratio"
