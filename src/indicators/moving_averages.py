...
def calculate_ema(data: Union[np.ndarray, list], period: int, 
...
def calculate_vwma(data: Union[np.ndarray, list], volume: Union[np.ndarray, list], 
...
def calculate_ma_envelope(data: Union[np.ndarray, list], period: int, 
                         envelope_pct: float = 0.025) -> tuple:
    """
