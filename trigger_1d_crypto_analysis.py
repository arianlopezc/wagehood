#!/usr/bin/env python3
"""
1-Day Crypto Analysis Trigger Script

Triggers 1-day timeframe analysis for cryptocurrency pairs using MACD+RSI and Support/Resistance strategies.
Runs 24/7 without market hours restrictions.
"""
...
SUPPORTED_SYMBOLS = os.getenv('SUPPORTED_CRYPTO_SYMBOLS', '').split(',')
...
class RealTime1DAnalyzer:
    ...
    async def run_analysis(self):
        ...
        # Crypto markets run 24/7, no market hours check needed
        session_type = "24/7"  # Always active for crypto
        logger.info("📈 Crypto market session: 24/7")
