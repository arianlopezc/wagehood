...
class TestLogger:
    ...
    def _generate_session_summary(self):
        ...
        summary = {
            ...
            'session_start': session_logs[0].timestamp.isoformat() if session_logs else None,
            'session_end': session_logs[-1].timestamp.isoformat() if session_logs else None
        }
...
class TestContextLogger:
    ...
    def __init__(self, logger: logging.Logger, test_suite: str, session_id: Optional[str] = None):
        self.logger = logger
